...
written code this module's src has been split into two directories:
- [backbase](boat-bay-server/src/backbase) contains 
out custom code
- [main](boat-bay-server/src/backbase) contains generated code.

Boat Bay generates controller interfaces and models from the API specs stored in [boat-bay-api](boat-bay-api). 
