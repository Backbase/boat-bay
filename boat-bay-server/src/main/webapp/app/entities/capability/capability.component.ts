...
export class CapabilityComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.capabilityService
      ...
      .subscribe(
        (res: HttpResponse<ICapability[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCapabilities(): void {
    this.eventSubscriber = this.eventManager.subscribe('capabilityListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICapability[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
