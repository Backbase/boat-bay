...
export class SpecComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.specService
      ...
      .subscribe(
        (res: HttpResponse<ISpec[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSpecs(): void {
    this.eventSubscriber = this.eventManager.subscribe('specListModification', () => this.loadPage());
  }
