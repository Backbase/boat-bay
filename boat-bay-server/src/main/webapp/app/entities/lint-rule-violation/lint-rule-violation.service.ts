...
type EntityResponseType = HttpResponse<ILintRuleViolation>;
type EntityArrayResponseType = HttpResponse<ILintRuleViolation[]>;

@Injectable({ providedIn: 'root' })
export class LintRuleViolationService {
  public resourceUrl = SERVER_API_URL + 'api/lint-rule-violations';
  ...
  update(lintRuleViolation: ILintRuleViolation): Observable<EntityResponseType> {
    return this.http.put<ILintRuleViolation>(this.resourceUrl, lintRuleViolation, { observe: 'response' });
  }
