...
describe('Service Tests', () => {
  describe('PortalLintRule Service', () => {
    let injector: TestBed;
    let service: PortalLintRuleService;
    let httpMock: HttpTestingController;
    let elemDefault: IPortalLintRule;
    let expectedResult: IPortalLintRule | IPortalLintRule[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a PortalLintRule', () => {
        ...
        service.create(new PortalLintRule()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should delete a PortalLintRule', () => {
