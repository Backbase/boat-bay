...
/**
 * Spring Data  repository for the ProductRelease entity.
 */
@Repository
public interface ProductReleaseRepository extends JpaRepository<ProductRelease, Long> {

    @Query(value = "select distinct productRelease from ProductRelease productRelease left join fetch productRelease.specs",
